        ...
        <div class="main">
            <div class="column" id="desktop">
                <h2>
                    ...
                    <div class="gps_result_new hide"><a href="#" class="thickbox"><span id="pagespeed_desktop_new" title="<?php esc_attr_e('New score (click to test website in popup)'); ?>">&nbsp;</span></a></div>
                </h2>
                ...
                <div id="desktop-waiting">
                    ...
                    <div id="desktop_<?php echo $section->id; ?>">
                        <div class="header">
                            ...
                            _e("Color of enabled switch depends on how it affects your website's PageSpeed Insights score. Green: improves the score; Orange: minor or none effect on the score; Red: negative effect on the score.");
            ...
            <div class="column" id="mobile">
                <h2>
                    ...
                    <div class="gps_result_new hide"><a href="#" class="thickbox"><span id="pagespeed_mobile_new" title="<?php esc_attr_e('New score (click to test website in popup)'); ?>">&nbsp;</span></a></div>
                </h2>
            ...
            <div class="column" id="usability">
                <h2>
                    ...
                    <div class="gps_result_new hide"><a href="#" class="thickbox"><span id="pagespeed_usability_new" title="<?php esc_attr_e('New score (click to test website in popup)'); ?>">&nbsp;</span></a></div>
                </h2>
