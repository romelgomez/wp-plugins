...
class Ressio
{
    ...
    public static function autoloader($class)
    {
        ...
        if ($pos === 0) {
            if (strpos($class, 'Ressio_Plugin_') === 0) {
