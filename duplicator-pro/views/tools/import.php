		...
		<div style="margin:auto; text-align: center;">
			...
			<div class="import-accept">
				...
				<label for="enable-installer">
					<?php DUP_PRO_U::_e("Yes. I would like to continue and understand that this site I'm currently logged into will be <u>overwritten</u> with the contents of "
						. "the uploaded archive.  The database above will be overwritten with the contents of the database from the archive."); ?>
				</label><br/><br/>
