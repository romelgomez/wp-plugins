...
<div id="dup-help-scanner" class="help-page">
	...
	<tr>
		<td>Import Install</td>
		<td>
			This mode indicates that the archive file was imported into an existing site (see Duplicator Pro &gt; Tools &gt; Import) and will <b>overwrite</b> the currect
			site.
		</td>
	</tr>
	<tr>
		<td>Import Install <br/> Database Only</td>
		<td>
			This mode indicates that the archive file was imported into an existing site (see Duplicator Pro &gt; Tools &gt; Import) and will <b>overwrite</b> the currect
			database but leave the current files intact.
		</td>
	</tr>
	</table>
	<br/><br/>
