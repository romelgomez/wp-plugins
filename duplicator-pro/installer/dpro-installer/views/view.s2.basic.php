...
$is_import_mode   = $state->mode == DUPX_InstallerMode::ImportInstall;
...
<div id="s2-db-basic">
	<table class="dupx-opts">
		...
		<?php if($is_import_mode) : ?>
			<tr><td colspan="2" style="text-align:right"><a href="javascript:void(0)" onclick="DUPX.basicDBToggleImportMode('toggle')">Edit Setup</a></td></tr>
		<?php endif; ?>
	</table>
</div>
<br/><br/>
