...
class PeepSoDeveloperToolsPageGit extends PeepSoDeveloperToolsPage
{
	public function __construct()
	{
		$this->title 		= __('Git Repositories', 'PeepSoDeveloperToolsPageunexpectedoutput');
		$this->description	= __('Simple list of all git tracked plugins and themes. Exports as a formatted .txt file.', 'peepsodebug');
	}
