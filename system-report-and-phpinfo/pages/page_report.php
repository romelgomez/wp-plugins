...
class PeepSoDeveloperToolsPageReport extends PeepSoDeveloperToolsPage
{
	public function __construct()
	{
		$this->title 		= __('System Report', 'peepsodebug');
		$this->description	= __('Overview your vital WordPress and environment data. Exports as formatted .txt file.', 'peepsodebug');
	}
	...
	public function page_data()
	{
		...
		$report	.= 'WP Memory Limit:'."\t\t\t".PeepSoDeveloperTools::num_convt( WP_MEMORY_LIMIT )/( 1024 ).'MB'."\n";
