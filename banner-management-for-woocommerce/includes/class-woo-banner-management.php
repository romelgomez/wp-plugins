...
class Woo_Banner_Management {
    ...
    private function define_admin_hooks() {
        ...
        $this->loader->add_action('wp_ajax_wcbm_free_subscribe_newsletter', $plugin_admin, 'wcbm_free_subscribe_newsletter');
        $this->loader->add_action('wp_ajax_nopriv_wcbm_free_subscribe_newsletter', $plugin_admin, 'wcbm_free_subscribe_newsletter');
