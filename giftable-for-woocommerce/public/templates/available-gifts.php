...
<div class="dgfw-available-gifts">
    <div id="dgfw-choose-gift">
        ...
        <h3 class="dgfw-available-gifts-title">
            <img src="https://www.naishair.com/wp-content/uploads/2018/01/Titulo.png" alt="Enhorabuena elige tu regalo" class="nice-gift">
        </h3>
            ...
            <?php foreach ($available_gifts as $gift) : ?>
                <div id="dgfw-gift-<?php echo $gift->get_id(); ?>" class="dgfw-gift">
                    ...
                    <?php if (DGFW_Public::gift_has_giftable_variations($gift)) : ?>
                        ...
                        <button id="dgfw-gift-link-<?php echo $gift->get_id(); ?>" name="update_cart" class="button dgfw-select-gift-button" data-gift="<?php echo $gift->get_id(); ?>">Elegir Regalo</button>
                    <?php else: ?>
                        ...
                        <button id="dgfw-gift-link-<?php echo $gift->get_id(); ?>" name="update_cart" class="button dgfw-add-gift-button" data-gift="<?php echo $gift->get_id(); ?>">Elegir Regalo</button>
                    <?php endif; ?>
                </div>
            <?php endforeach; ?>
        </div>
