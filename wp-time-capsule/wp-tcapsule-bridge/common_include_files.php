...
class Common_Include_Files{
	...
	public function start_sentry_restore_logs(){
		$this->include_file( $this->dir_path.'Classes/Sentry/SentryRestore.php');
	}
	...
	public function include_primary_files_wptc(){
		...
		$this->include_file( $this->dir_path.'Classes/Sentry/init.php');
		$this->include_file( $this->dir_path.'Classes/Sentry/Hooks.php');
		$this->include_file( $this->dir_path.'Classes/Sentry/HooksHandler.php');
		$this->include_file( $this->dir_path.'Classes/Sentry/Config.php');
		$this->include_file( $this->dir_path.'Classes/Sentry/Sentry.php');
