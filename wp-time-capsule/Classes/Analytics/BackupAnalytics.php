...
class Wptc_Backup_Analytics extends Wptc_Analytics {
	...
	public function get_ptc_meta(){
		...
		$plugins_to_exclude_slugs = empty($vulns_setting['plugins_to_exclude'])
									? array() : array_values($vulns_setting['plugins_to_exclude']) ;
		...
		$ptc_meta['ptc_meta']['themes_to_exclude'] = empty($vulns_setting['themes_to_exclude'])
													? array() : array_values($vulns_setting['themes_to_exclude']) ;
