jQuery(document).ready(function($) {
	...
	if ( anchor_wptc.val() == '#wp-time-capsule-tab-net' ||  anchor_wptc.val() == '#wp-time-capsule-tab-information' || anchor_wptc.val() == "#wp-time-capsule-tab-general" || anchor_wptc.val() == '') {
	...
	tab_wrapper_a_wptc.on( 'click', function () {
		...
		if ( clickedid == '#wp-time-capsule-tab-net' ||  clickedid == '#wp-time-capsule-tab-information' || clickedid == "#wp-time-capsule-tab-general" || clickedid == '') {
			$('#wptc_save_changes').hide();
			$('#default_settings').hide();
		} else {
