...
class WPTC_Constants{
	...
	public function versions(){
		$this->define( 'WPTC_VERSION', '1.15.1' );
	...
	public function general(){
		...
		$this->define( 'WPTC_FALLBACK_REVISION_LIMIT_DAYS', 15 );
		...
		$this->define( 'WPTC_STAGING_DEFAULT_FILE_COPY_LIMIT', 500);
		$this->define( 'WPTC_STAGING_DEFAULT_COPY_DB_ROWS_LIMIT', 1000);
		$this->define( 'WPTC_KEEP_MAX_BACKUP_DAYS_LIMIT', 150);
	...
	public function path(){
		...
		$this->define( 'WPTC_RELATIVE_UPLOADS_DIR', str_replace(WPTC_ABSPATH, WPTC_RELATIVE_ABSPATH, $basedir_path ) );
	...
	public function production_mode(){
		...
		$this->define( 'WPTC_SENTRY_REFERENCE', 'http://c2b71bf9cff94377980d6d11f0e6ab6b:af8ed08f439f4bb7bb8c23461d8abd6b@bugreports.rxforge.in/3');
	}
	...
	public function staging_mode(){
		...
		$this->define( 'WPTC_CURL_TIMEOUT', 20 );
		$this->define( 'WPTC_SENTRY_REFERENCE', 'http://54bbcd50f5fd40b58f5e10e1aa288f99:7c2c1f318b104f89b2eb74cfbbe0796a@bugreports.rxforge.in/4');
	}
	...
	public function development_mode(){
		...
		$this->define( 'WPTC_CURL_TIMEOUT', 20 );
		$this->define( 'WPTC_SENTRY_REFERENCE', 'http://de2dbdbd588a4b13a128e1c4dd2cd123:83e348f73d034f60a44860501f3afded@bugreports.rxforge.in/5');
	}
}
